...
- Unit coverage is generated with `bun run test:coverage`.
- The current coverage gate requires at least `80%` for both functions and lines.
- The badge at `.github/badges/unit-coverage.svg` is regenerated by the same script.
